#!/bin/bash
export GITLAB_URL=cicd-dev-infra-lb-7f7e62117b32556e.elb.ap-northeast-2.amazonaws.com:8443
...
if [ $(curl --connect-timeout 600 -k -I "https://cicd-dev-infra-lb-7f7e62117b32556e.elb.ap-northeast-2.amazonaws.com:8443" 2>/dev/null | head -n 1 | cut -d$' ' -f2) -eq "302" ];
then  
