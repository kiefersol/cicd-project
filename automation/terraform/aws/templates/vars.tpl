...
kube_config: "/root/.kube/${vpc_name}-${system_type}-config"
...
harbor_install_dir: /home/sol/harbor/harbor
...
jenkins_version : 2.417
jenkins_base_dir : /mnt/nfs/jenkins
jenkins_port: 8080
...
nginx_cert_hosts: "\"jenkins.sol.test\",\"monitoring.sol.test\", \"{{infra_lb_domain}}\""  
